...
data_dir=/asrDataCenter/dataCenter/aligned_audios/batch1_53hours_full
...
dicFile=/asrDataCenter/dataCenter/aligned_audios/batch1_53hours_full/lm/dic4LM.dic
...
;;'
  ...
  utils/validate_data_dir.sh --no-feats ${dir} || exit 4
done
