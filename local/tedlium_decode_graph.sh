...
#arpa_lm=/asrDataCenter/dataCenter/asr/tedlium/cantab-TEDLIUM/cantab-TEDLIUM-pruned.lm3.gz
arpa_lm=/asrDataCenter/dataCenter/aligned_audios/batch1_53hours_full/lm/txt4LM.lm3.gz
oov_list=/dev/null
#oov_list=/home/zhangjl/dataCenter/lm/engLMData/oov.txt
